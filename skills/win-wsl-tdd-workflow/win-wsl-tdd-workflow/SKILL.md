...
### 6) Review end-to-end impact and open a PR

After tests pass, review the full change impact across the system. Summarize any
behavioral changes, compatibility risks, or downstream effects. If everything is
LGTM, open a PR using the local machine credentials.
